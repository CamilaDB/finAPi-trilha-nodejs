...
//import { ICreateTransferDTO } from "../useCases/transfers/ICreateTransferDTO";
import { IGetBalanceDTO } from "../useCases/getBalance/IGetBalanceDTO";
import { IGetStatementOperationDTO } from "../useCases/getStatementOperation/IGetStatementOperationDTO";

export interface IStatementsRepository {
  create: (data: ICreateStatementDTO) => Promise<Statement>;
  //createTransfer: (data: ICreateTransferDTO) => Promise<{sender_id: string, amount: number, description: string, type: string}>;
